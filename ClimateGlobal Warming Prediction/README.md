...
![GitHub repo size](https://img.shields.io/github/repo-size/OkomoJacob/timeSeriesForecasting?color=green-yellow&logo=github&logoColor=blue) ![GitHub language count](https://img.shields.io/github/languages/count/OkomoJacob/timeSeriesForecasting?logo=visual-studio-code) ![GitHub last commit](https://img.shields.io/github/last-commit/OkomoJacob/timeSeriesForecasting?style=plastic&color=brightgreen) 
